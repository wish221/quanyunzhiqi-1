      ...
      activities: [
        {
          id: 'spring-worship',
          name: '济南国际泉水节',
          description: '传承千年的泉水文化，体验泉水带给济南的快乐',
          season: '夏季',
          location: '开幕式在大明湖超然楼',
          participants: '超百万人',
        ...
        },
        {
          ...
          location: '大明湖、趵突泉等',
          participants: '自由组织人数',
          image: 'https://pic.nximg.cn/file/20220302/33458386_142541327107_2.jpg',
          rating: 4.6,
          tags: ['茶艺文化', '泉水特色', '休闲体验']
        },
        {
          id: 'spring-poetry',
          name: '五龙潭泼水节',
          description: '享受夏日狂欢，感受泉城济南的泉水魅力和戏水之乐',
          season: '夏季',
          location: '五龙潭',
          participants: '自由组织人数',
          image: 'https://img5.iqilu.com/c/u/2019/0825/1566691740913.jpg',
          rating: 4.7,
          tags: ['消夏避暑', '亲子互动', '放松身心']
        }
      ]
  ...
  const getActivityDetails = (activity: FolkloreActivity) => {
    const detailsMap: { [key: string]: any } = {
      'spring-worship': {
        history: {
          title: '历史溯源',
          content: `首届于 2013 年 8 月下旬至 9 月上旬举行，每年举办一届，从 2018 年升级为 “济南国际泉水节”。

历史发展脉络：
• 春秋时期：齐国建立最早的泉神祭祀制度，人们开始了有关泉水的活动
• 汉唐时期：仪式逐渐规范化，形成固定的祭祀程序
• 宋元时期：文人参与，增加了诗词吟诵环节
• 明清时期：民间活动与官方活动并存，形成完整体系
• 现代传承：结合旅游文化，以体验形式传承至今

泉水节不仅是对自然的敬畏，更体现了济南人与泉水和谐共生的文化理念。`
        },
        experience: {
          title: '当代体验形式',
          content: `现代济南国际泉水节体验融合了传统仪式与现代文化需求，形成了独特的文化体验项目。

体验内容包括：
• 泉水奇妙夜：通常作为泉水节开幕式，如 2024 年泉水节开幕式在大明湖超然楼前举行，有 “裸眼 3D+AI” 特效主题片《AI 咏泉》
• 泉水非遗集市：主打 “消费 + 文化”，将非遗文化与泉水文化相结合，市民可以边走边吃，边看边逛，体验丰富多彩的非遗项目，感受传统文化的魅力。
• 花船巡游：是泉水节的传统项目。活动期间，市民可观赏到设计契合 “泉水” 主题，辅以荷花、柳树等济南元素的花船，乘船游览大明湖，感受碧波荡漾与凉风习习。

特色亮点：
• 全民参与性强：秉持 “开门办节、开放办节，让人民参与，由群众主导” 的核心理念，设置了众多适合不同群体参与的活动。
• 科技感十足：运用现代科技手段提升体验。超燃 3D Mapping Show 以超然楼为投影载体，呈现济南四季与泉水融合的光影故事，实现虚拟演出效果，带来震撼视觉体验。
• 文化融合度高：将泉水文化与多种文化形式深度融合。
        },
        guide: {
          title: '实操指南',
          content: `参与准备：
...
具体活动：
1.花船巡游：分为护城河游船路线和大明湖游船路线，均有日间和夜航时段。可在码头处购票乘船，护城河游船日间 9：00—17：30 从黑虎泉船站出发，夜航 19：30—21：00 出发；大明湖游船南门码头和超然楼码头日间 9：00—17：30 运营，夜航 17：30—21：00 运营，具体可根据当日天气、客流等情况调整。

2.济南国际泉水节夜光欢乐跑：需在提前报名，可通过相关报名渠道（具体可关注 “济南泉水节” 小程序或官方媒体公告）报名

3. （具体活动每一年可能会变化，可提前关注）

参与方式：
部分活动如济南国际泉水节夜光欢乐跑等需要提前报名，可关注 “济南泉水节” 小程序或官方媒体公告，获取报名渠道和时间等信息，按要求填写相关信息完成报名，并缴纳相应费用即可参加。

注意事项
泉水节期间济南游客较多，建议提前预订酒店和车票。
。活动分布在多个地点，可根据行程合理选择交通工具，如需乘坐公共交通，可通过地图软件查询线路。
• 另外，注意关注天气变化，提前做好防晒、防雨等准备。`
        }
      },
      'spring-tea-ceremony': {
        history: {
...
• 元代：人们在潭边建五龙庙，内塑五方龙神掌管着东、南、西、北、中五方水事，祈愿风调雨顺
• 现代：延续了亲水、祈福的文化基因，又注入现代娱乐元素

文化意义：
延续民俗祈福的精神内核，构建亲子与社群的情感联结。`
        },
        experience: {
          title: '当代体验形式',
...
• 观看精彩演出：每周末下午 15：00-16：00，前往樱花林广场西北角，可欣赏民谣乐队演出、川剧变脸、奇幻魔术、欢乐小丑互动等精彩节目，感受不一样的视听盛宴。
• 体验亲水之乐：泼水节依托五龙潭的泉水资源，可在濂泉戏水平台等区域，参与水枪大战等活动，享受泉水带来的清凉，体验亲水乐趣，感受泉城济南的泉水魅力。
