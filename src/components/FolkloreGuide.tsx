  ...
  const activities: Activity[] = [
    {
      ...
      details: {
        history: {
          title: '历史溯源',
          content: `济南国际泉水节源于对济南独特泉水文化的挖掘与弘扬。为进一步彰显泉水魅力、传承泉水文化，济南整合各类泉水相关活动，打造出具有国际影响力的泉水节，以泉为媒，联结世界，祈求城市蓬勃发展、泉脉永续传承。成长拓展：[起始年份区间2] ，引入国际元素，增加泉水文化交流论坛、国际泉水城市互动等内容，扩大节日影响力 。\n- 成熟深化：[近年起始年份区间] ，完善活动体系，涵盖文化、旅游、生态、经贸等多领域，成为济南城市文化名片 。\n\n文化价值： 是济南泉水文化对外传播的重要窗口，促进国内外泉水文化交流互鉴，彰显济南开放包容的城市精神，凝聚市民对家乡泉水文化的认同感与自豪感，推动泉水文化在新时代创新传承。。
...
文化价值：体现了济南人与自然和谐共生的理念，是重要的非物质文化遗产。`
        ...
        experience: {
          title: '当代体验形式',
          content: `现代泉神祭祀仪式融合传统与创新，为游客提供深度文化体验：
